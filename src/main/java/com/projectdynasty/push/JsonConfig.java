...
public class JsonConfig {
    ...
    public void saveConfig() {
        ...
        try (final FileWriter writer = new FileWriter(this.file)) {
            writer.write(PushService.GSON.toJson(this.object));
        } finally {
            return;
        }
    }
    ...
    public <T> T get(String key, Class<T> tClass) {
        ...
        return PushService.GSON.fromJson(this.object.get(key), tClass);
    }
    ...
    public <T> T set(String key, T t) {
        this.object.add(key, PushService.GSON.toJsonTree(t));
        return t;
    }
